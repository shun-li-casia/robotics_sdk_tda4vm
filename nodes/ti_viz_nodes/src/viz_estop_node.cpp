...
namespace ros_app_viz
{
    ...
    public:
                            ...
                            const ImageConstPtr& tensorPtr)
        {
            ...
            numObjs = detectionMsg.numObjects;
            objPosArr = (ObjectPos3D *) detectionMsg.objPos3D.data();
            ...
            for (i = 0; i < numObjs; i++)
            {
                ...
                sprintf(strDistance, "%.1fm", float(objPos.frontDepth / 1000));
